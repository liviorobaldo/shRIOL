...
that can formally describe constraints on the structure of RDF nodes and edges. The RDF graphs that satisfy the constraints denoted by the SHACL shapes are said to be <i>valid</i> with respect to those shapes.
